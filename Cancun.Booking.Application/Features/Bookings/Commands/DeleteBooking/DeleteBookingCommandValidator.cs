...
namespace Cancun.Booking.Application.Features.Bookings.Commands.DeleteBooking
{
  internal class DeleteBookingCommandValidator : AbstractValidator<DeleteBookingCommand>
  {
    ...
    public DeleteBookingCommandValidator(IBookingRepository bookingRepository, IUserRepository userRepository)
    {
    ...
    private async Task<bool> IsMyBoooking(DeleteBookingCommand arg1, CancellationToken arg2)
    {
    ...
    private async Task<bool> ExistsBooking(DeleteBookingCommand e, CancellationToken token)
    {
